    ...
    <HTML>
      ...
      <BODY bgcolor="#B5C1CF" topmargin="5" leftmargin="0" marginwidth="0" marginheight="5">
          <TABLE width="100%" border="0" cellspacing="0" cellpadding="4">
            <TR>
                <TD colspan="2" height="22" class="testoNero"><img src="images/icona_help.gif" align="absmiddle"/>JWebMail Súgó
                </TD>
            </TR>
            <TR>
            ...
            <TR>
              ...
              <TD height="22" class="testo" width="89%" bgcolor="#E2E6F0">
                ...
                JWebMail <xsl:apply-templates select="/USERMODEL/STATEDATA/VAR[@name='webmail version']"/> (c)1999-@year@ Sebastian Schaffert, schaffer@informatik.uni-muenchen.de
              </TD>
            </TR>
          </TABLE>
      </BODY>
